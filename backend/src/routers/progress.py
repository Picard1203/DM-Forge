...
from src.deps import get_current_user, get_gamification_service, get_progress_service
from src.models.user import User
from src.schemas.progress import CompleteTaskRequest, ProgressOverviewResponse
